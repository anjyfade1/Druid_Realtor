...
import { Box,Icon,Flex,Text,Avatar,Spacer } from "@chakra-ui/react";
  ...
  return (
    <Box maxWidth="1000px" margin="auto" p="4" >
        ...
        <Box w="full" p="6" >
            <Flex paddingTop="2" alignItems="center" justifyContent="space-between"  >
                <Flex alignItems="center" >
                    <Box paddingRight="3" color="green.400" justifyContent="space-between">
        ...
        <Flex flexWrap="wrap" textTransform="uppercase" justifyContent="space-between" >
            <Flex justifyContent="space-between" w='450px' m="auto" borderBottom='1px' borderColor='gray.100' p='3'   >
                <Text>Type</Text>
            ...
            {furnishingStatus &&  (<Flex justifyContent="space-between"w='450px' borderBottom='1px' borderColor='gray.100' p='3'  >
